    ...
    <>
      ...
      <PageBackground className="p-4 md:p-8">
        <div className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-500 text-white rounded-[26px] p-6 md:p-8 shadow-xl shadow-blue-600/20 grid grid-cols-1 md:grid-cols-[1.3fr_0.7fr] items-center gap-6 mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex gap-3.5 flex-wrap mt-2">
              <Link
                to="/lockers"
                className="inline-block rounded-xl px-5 py-3 font-bold transition-all duration-300 bg-[oklch(48.8%_0.243_264.376)] text-white shadow-lg shadow-blue-900/40 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl hover:opacity-90 border border-blue-400"
              >
                Book Locker
              </Link>
              <Link
                to="/parking/zones"
                className="inline-block rounded-xl px-5 py-3 font-bold transition-all duration-300 bg-[oklch(48.8%_0.243_264.376)] hover:opacity-90 text-white shadow-lg shadow-blue-900/40 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl border border-blue-400"
              >
                Book Parking Slot
              </Link>
              <Link
        ...
        <div className="mt-8">
          <Link
            to="/student-profile"
            className="inline-block rounded-xl px-5 py-3 font-bold transition-all duration-300 bg-gradient-to-br from-slate-800 to-slate-900 text-white shadow-lg shadow-slate-600/20 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-xl"
          >
            Manage Profile
          </Link>
        </div>
