    ...
    <div className="min-h-screen bg-[#f8fafc]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* Vehicle Info */}
          <div className="lg:col-span-1 p-6 bg-white rounded-3xl border border-black shadow-sm">
          ...
          {/* Activity Timeline */}
          <div className="lg:col-span-2 p-6 bg-white rounded-3xl border border-black shadow-sm">
            <h3 className="text-lg font-bold text-slate-800 mb-6 flex items-center gap-2 text-left">
              <span className="p-2 rounded-xl bg-slate-50 text-slate-600">📊</span>
              Activity Summary
            </h3>
