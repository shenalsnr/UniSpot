...
doc.roundedRect(20, 5, 50, 40, 5, 5, 'F');
...
doc.text("Locker Details", 28, 155);
...
const targetPath = path.join(__dirname, '..', 'backend', 'uploads', 'templates', 'locker_receipt_template.pdf');
fs.writeFileSync(targetPath, Buffer.from(templateBuffer));
